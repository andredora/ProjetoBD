...
-- esta cena da pra filtrar por: loja, universidade e genero
-- GUIA DE GENERO: M - Masculino, F - Feminino, N - Neutro (APARECE EM AMBOS OS FILTROS AKA APARECE SEMPRE)
...
('PT0033', 'Gabao', 'M', 'Universidade de Aveiro', 'Rachel Street, N.o 2, Aveiro', 40, 'N'),
...
--('Rua do Silencio, N.o 4, Aveiro', 'Trajes Rikka e Etc', 9827381821)
...
insert into traje (id, num_acessorios, num_pecas, completo,  End_Loja) values
('T0001', 6, 3, 0, 'Rua do Silencio, N.o 4, Aveiro');

insert into peca_do_traje_comprada(id_traje, id_peca) values 
();
