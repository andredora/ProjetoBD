...
namespace TrabalhoFinal
{
    public partial class Form1 : Form
    {
        ...
        private void DeletePapelaria(string idArtigo)
        {

            using (SqlConnection conn = getSqlConn())
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("DeletePapelaria", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@IDPAPEL", idArtigo);

                    cmd.ExecuteNonQuery();

                    // Exibe a mensagem de sucesso
                    MessageBox.Show("Artigo de papelaria removido com sucesso!");
                }
            }
        }
        ...
        private void AdicionarAoTrajebuttonAA_Click(object sender, EventArgs e)
        {
            if (listBoxAA.SelectedItem != null)
            {
                ...
                if (popup.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("Artigo académco adicionado ao traje com sucesso!");
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (listBox3.SelectedItem != null)
            {
                ...
                if (popup.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("Peça adicionada ao traje com sucesso!");
        ...
        private void BNovoTraje_Click(object sender, EventArgs e)
        {
            using (FormNovoTraje form = new FormNovoTraje())
            {
                if (form.ShowDialog() == DialogResult.OK)
                {
                    ...
                    MessageBox.Show("traje adicionado com sucesso.");
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            if (listBoxTrajes.SelectedItem != null)
            {
                ...
                MessageBox.Show("Traje apagado com sucesso");
        ...
        private void button13_Click(object sender, EventArgs e)
        {
            ...
            PopupForm popup = new PopupForm(id_peca);
            popup.ShowDialog();
            PreencherPecasDoTraje(GetPecasDoTraje());
        ...
        private void LabelMarcaAP_Click(object sender, EventArgs e)
        {

        }

        private void LabelEnderecoAP_Click(object sender, EventArgs e)
        {
        ...
        private void DeletePeca(string idArtigo)
        {

            using (SqlConnection conn = getSqlConn())
            {
                conn.Open();
                using (SqlCommand cmd = new SqlCommand("DeletePeca", conn))
                {
                    cmd.CommandType = CommandType.StoredProcedure;
                    cmd.Parameters.AddWithValue("@IDPECA", idArtigo);

                    cmd.ExecuteNonQuery();

                    // Exibe a mensagem de sucesso
                    MessageBox.Show("Peca do traje removida com sucesso!");
                }
                ...
                List<string> conteudos = new List<string>
    {
        ...
        public partial class PopupForm : Form
        {
            ...
            public PopupForm(string selectedId)
            {
            ...
            private void InitializeComponent()
            {
                ...
                this.labelQuantidade.Location = new System.Drawing.Point(12, 50);
                ...
                this.labelEndereco.Location = new System.Drawing.Point(12, 85);
                this.labelEndereco.Name = "labelEndereco";
                this.labelEndereco.Size = new System.Drawing.Size(78, 13);
                this.labelEndereco.TabIndex = 2;
                this.labelEndereco.Text = "Universidade:";

                this.labelTamanho.AutoSize = true;
                this.labelTamanho.Location = new System.Drawing.Point(12, 120);
                ...
                this.labelGenero.Location = new System.Drawing.Point(12, 155);
                ...
                // TextBox positions
                this.textBoxNome.Location = new System.Drawing.Point(120, 15);
                this.textBoxNome.Name = "textBoxNome";
                this.textBoxNome.Size = new System.Drawing.Size(200, 20);
                this.textBoxNome.TabIndex = 6;

                this.textBoxQuantidade.Location = new System.Drawing.Point(120, 50);
                this.textBoxQuantidade.Name = "textBoxQuantidade";
                this.textBoxQuantidade.Size = new System.Drawing.Size(200, 20);
                this.textBoxQuantidade.TabIndex = 7;

                this.textBoxEndereco.Location = new System.Drawing.Point(120, 85);
                this.textBoxEndereco.Name = "textBoxEndereco";
                this.textBoxEndereco.Size = new System.Drawing.Size(200, 20);
                this.textBoxEndereco.TabIndex = 8;

                this.textBoxTamanho.Location = new System.Drawing.Point(120, 120);
                this.textBoxTamanho.Name = "textBoxTamanho";
                this.textBoxTamanho.Size = new System.Drawing.Size(200, 20);
                this.textBoxTamanho.TabIndex = 9;

                this.textBoxGenero.Location = new System.Drawing.Point(120, 155);
                ...
                // Button OK
                this.buttonOK.Location = new System.Drawing.Point(145, 195);
                this.buttonOK.Name = "buttonOK";
                this.buttonOK.Size = new System.Drawing.Size(75, 28);
                this.buttonOK.TabIndex = 12;
                this.buttonOK.Text = "Alterar";
            ...
            private void LoadDetails(string selectedId)
            {
                try
                {
                    using (SqlConnection conn = getSqlConn())
                    {
                        ...
                        using (SqlCommand command = new SqlCommand(query, conn))
                        {
                            ...
                            using (SqlDataReader reader = command.ExecuteReader())
                            {
                                while (reader.Read())
                                {
                                    textBoxEndereco.Text = reader["Universidade"].ToString();
            ...
            {
                // Verifique se todos os campos foram preenchidos antes de prosseguir
                if (textBoxNome.Text == "" || textBoxTamanho.Text == "" ||
                    textBoxEndereco.Text == "" || textBoxQuantidade.Text == "" || textBoxGenero.Text == "")
                {
                    MessageBox.Show("Por favor, preencha todos os campos.");
                    return;
                }

                // Conexão com o banco de dados (substitua 'connectionString' com a sua string de conexão)

                SqlConnection connection = getSqlConn();

                // Comando SQL para chamar a stored procedure
                string sql = "AlterarPecaDoTraje";

                // Criação do comando
                SqlCommand command = new SqlCommand(sql, connection);
                command.CommandType = CommandType.StoredProcedure;

                // Adicionando os parâmetros à stored procedure
                command.Parameters.AddWithValue("@pecaID", this.selectedId);
                command.Parameters.AddWithValue("@novoNome", textBoxNome.Text);
                command.Parameters.AddWithValue("@novoTamanho", textBoxTamanho.Text);
                command.Parameters.AddWithValue("@novaUniversidade", textBoxEndereco.Text);
                command.Parameters.AddWithValue("@novaQuantidade", Convert.ToInt32(textBoxQuantidade.Text));
                command.Parameters.AddWithValue("@novoGenero", textBoxGenero.Text);
                ...
                try
                {
                    ...
                    MessageBox.Show("Peca de traje atualizada com sucesso!");
                ...
                {
                    MessageBox.Show("Erro ao atualizar a peça de traje: " + ex.Message);
                }
                finally
                {
                    // Fecha a conexão caso ocorra uma exceção
